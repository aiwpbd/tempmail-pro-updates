...
<div class="wrap tmpmp-admin-wrap">
    ...
    <div class="tmpmp-dash-header">
        ...
        <div class="tmpmp-dash-header-links">
            <a href="<?php echo admin_url('admin.php?page=tmpmp-settings'); ?>" class="tmpmp-hdr-btn tmpmp-hdr-btn--outline">
                ...
                <?php esc_html_e('Settings','tempmail-pro'); ?>
            </a>
            <a href="<?php echo admin_url('admin.php?page=tmpmp-analytics'); ?>" class="tmpmp-hdr-btn tmpmp-hdr-btn--primary">
                ...
                <?php esc_html_e('Analytics','tempmail-pro'); ?>
            </a>
        </div>
    </div>
